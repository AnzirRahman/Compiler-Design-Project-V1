...
{
  "\"end of file\"", "error", "\"invalid token\"", "ID", "NUM", "ASSIGN",
  "PLUS", "MINUS", "TIMES", "DIVIDE", "LPAREN", "RPAREN", "SEMICOLON",
  "$accept", "stmt", "expr", "term", "factor", YY_NULLPTR
};
...
{
      17,   -11,     0,    12,   -12,    -1,   -12,   -12,   -12,   -12,
       3,     4,    13,   -12,    -3,     8,    -1,    -1,   -12,    -1,
      -1,   -12,   -12,    13,    13,   -12,   -12
};
...
{
       0,     0,     0,     0,     3,     0,     1,    14,    12,    13,
       0,     0,     6,     9,    14,     0,     0,     0,     2,     0,
       0,    11,    10,     4,     5,     7,     8
};
...
{
       7,     4,     8,     9,    14,     5,     8,     9,    21,    10,
      16,    17,     6,    10,    16,    17,    18,     0,     1,    22,
       2,    19,    20,    23,    24,    25,    26,     0,    15
};

static const yytype_int8 yycheck[] =
{
       1,    12,     3,     4,     1,     5,     3,     4,    11,    10,
       6,     7,     0,    10,     6,     7,    12,    -1,     1,    11,
       3,     8,     9,    16,    17,    19,    20,    -1,    10
};
...
{
       0,     1,     3,    14,    12,     5,     0,     1,     3,     4,
      10,    15,    16,    17,     1,    15,     6,     7,    12,     8,
       9,    11,    11,    16,    16,    17,    17
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* stmt: ID ASSIGN expr SEMICOLON  */
#line 30 "parser.y"
                               {
...
#line 40 "parser.y"
                     {
          if (strcmp((yyvsp[0].str), "error") == 0) {
              yyerror("Missing operand after '+'");
              (yyval.str) = strdup("error");
          } else {
              char* temp = newTemp();
...
#line 1188 "parser.tab.c"
  ...
  case 11: /* factor: LPAREN error RPAREN  */
#line 95 "parser.y"
                          {
